...
const RentModal = () => {
    ...
    //WE DO NOT IMPORT MAP TRADITIALLY. instead, we memoize it, using dynbamic loading to access the ssr, and set it to false.
    ...
    const onSubmit: SubmitHandler<FieldValues> = (data) => {
        ...
        axios.post('/api/listings', data)
             .then(() => {
                ...
                router.refresh();
                //resets the form values from the useForm.
                reset();
    ...
    if (step === STEPS.INFO) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                ...
                <hr />
                <Counter title='Bathrooms' subtitle="How many bathrooms do you allow?" value={bathroomCount} onChange={(value) => setCustomValue('bathroomCount', value)} />
            </div>
        )
    };
